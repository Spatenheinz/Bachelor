...
The only exception for this ~ChaCha~ as it still is a quite uncommon cipher.
All implementations synthesized using Xilinx Vivado on a Zynq Zedboard, which is a low-end FPGA.
...
Because of promising results, we further compare our results with an Intel i5-7500.
