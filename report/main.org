...
#+AUTHOR:
#+DATE:
#+LATEX_HEADER: \titel{\textbf{Bachelorproject}} \undertitel{Cryptographic library for FPGA's} \opgave{Bachelor Project} \forfatter{Jacob Herbst(mwr148), Jonas Flach Jensen (sjm233)} \dato{12 june 2021} \vejleder{Advisor: Kenneth Skovhede}
\maketitle
\tableofcontents
\newpage
...
# Carl sagde vi kunne bruge: https://www.ctan.org/pkg/ieeetran til mødet
