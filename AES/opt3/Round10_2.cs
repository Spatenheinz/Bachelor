...
namespace opt3
{
    ...
    class Round10_2 : SimpleProcess {
        ...
        private uint[] expandedKey128 = new uint[6];
        ...
        private void Encrypt128() {
            uint a0 = In.Block[4]; uint a1 = In.Block[5];
            uint a2 = In.Block[2]; uint a3 = In.Block[3];
            /* Round 9 */
            Out.Block[0] = In.Block[0];
            Out.Block[1] = In.Block[1];
			Out.Block[2] = T0[a2 >> 24] ^ T1[(byte)(a3 >> 16)] ^ T2[(byte)(a0 >> 8)] ^ T3[(byte)a1] ^ expandedKey128[4];
			Out.Block[3] = T0[a3 >> 24] ^ T1[(byte)(a0 >> 16)] ^ T2[(byte)(a1 >> 8)] ^ T3[(byte)a2] ^ expandedKey128[5];
        }
