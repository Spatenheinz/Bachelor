...
namespace opt1
{
    ...
    class Round4 : SimpleProcess {
        ...
        private uint[] expandedKey128 = new uint[12];
        ...
        private void Encrypt128() {
            ...
            Out.block[0] = (byte)(S[b0 >> 24] ^ (byte)(expandedKey128[8] >> 24));
			Out.block[1] = (byte)(S[(byte)(b1 >> 16)] ^ (byte)(expandedKey128[8] >> 16));
			Out.block[2] = (byte)(S[(byte)(b2 >> 8)] ^ (byte)(expandedKey128[8] >> 8));
			Out.block[3] = (byte)(S[(byte)b3] ^ (byte)expandedKey128[8]);

			Out.block[4] = (byte)(S[b1 >> 24] ^ (byte)(expandedKey128[9] >> 24));
			Out.block[5] = (byte)(S[(byte)(b2 >> 16)] ^ (byte)(expandedKey128[9] >> 16));
			Out.block[6] = (byte)(S[(byte)(b3 >> 8)] ^ (byte)(expandedKey128[9] >> 8));
			Out.block[7] = (byte)(S[(byte)b0] ^ (byte)expandedKey128[9]);

			Out.block[8] = (byte)(S[b2 >> 24] ^ (byte)(expandedKey128[10] >> 24));
			Out.block[9] = (byte)(S[(byte)(b3 >> 16)] ^ (byte)(expandedKey128[10] >> 16));
			Out.block[10] = (byte)(S[(byte)(b0 >> 8)] ^ (byte)(expandedKey128[10] >> 8));
			Out.block[11] = (byte)(S[(byte)b1] ^ (byte)expandedKey128[10]);

			Out.block[12] = (byte)(S[b3 >> 24] ^ (byte)(expandedKey128[11] >> 24));
			Out.block[13] = (byte)(S[(byte)(b0 >> 16)] ^ (byte)(expandedKey128[11] >> 16));
			Out.block[14] = (byte)(S[(byte)(b1 >> 8)] ^ (byte)(expandedKey128[11] >> 8));
			Out.block[15] = (byte)(S[(byte)b2] ^ (byte)expandedKey128[11]);
        }
