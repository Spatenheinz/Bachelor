...
namespace opt1
{
    ...
    class Round3 : SimpleProcess {
        ...
        private uint[] expandedKey128 = new uint[16];
        ...
        private void Encrypt128() {
			...
			/* Round 8 */
			Out.Block[0] = T0[a0 >> 24] ^ T1[(byte)(a1 >> 16)] ^ T2[(byte)(a2 >> 8)] ^ T3[(byte)a3] ^ expandedKey128[12];
			Out.Block[1] = T0[a1 >> 24] ^ T1[(byte)(a2 >> 16)] ^ T2[(byte)(a3 >> 8)] ^ T3[(byte)a0] ^ expandedKey128[13];
			Out.Block[2] = T0[a2 >> 24] ^ T1[(byte)(a3 >> 16)] ^ T2[(byte)(a0 >> 8)] ^ T3[(byte)a1] ^ expandedKey128[14];
			Out.Block[3] = T0[a3 >> 24] ^ T1[(byte)(a0 >> 16)] ^ T2[(byte)(a1 >> 8)] ^ T3[(byte)a2] ^ expandedKey128[15];
        }
