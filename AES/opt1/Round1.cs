...
namespace opt1
{
    ...
    class Round1 : SimpleProcess {
        ...
        private void Encrypt128() {
            ...
            uint a0 = (((uint)PlainText.block[0] << 24) | ((uint)PlainText.block[1] << 16) | ((uint)PlainText.block[2] << 8) | (uint)PlainText.block[3]) ^ expandedKey128[0];
			uint a1 = (((uint)PlainText.block[4] << 24) | ((uint)PlainText.block[5] << 16) | ((uint)PlainText.block[6] << 8) | (uint)PlainText.block[7]) ^ expandedKey128[1];
			uint a2 = (((uint)PlainText.block[8] << 24) | ((uint)PlainText.block[9] << 16) | ((uint)PlainText.block[10] << 8) | (uint)PlainText.block[11]) ^ expandedKey128[2];
			uint a3 = (((uint)PlainText.block[12] << 24) | ((uint)PlainText.block[13] << 16) | ((uint)PlainText.block[14] << 8) | (uint)PlainText.block[15]) ^ expandedKey128[3];
            /* Round 1 */
			...
			/* Round 2 */
			Out.Block[0] = T0[b0 >> 24] ^ T1[(byte)(b1 >> 16)] ^ T2[(byte)(b2 >> 8)] ^ T3[(byte)b3] ^ expandedKey128[8];
			Out.Block[1] = T0[b1 >> 24] ^ T1[(byte)(b2 >> 16)] ^ T2[(byte)(b3 >> 8)] ^ T3[(byte)b0] ^ expandedKey128[9];
			Out.Block[2] = T0[b2 >> 24] ^ T1[(byte)(b3 >> 16)] ^ T2[(byte)(b0 >> 8)] ^ T3[(byte)b1] ^ expandedKey128[10];
			Out.Block[3] = T0[b3 >> 24] ^ T1[(byte)(b0 >> 16)] ^ T2[(byte)(b1 >> 8)] ^ T3[(byte)b2] ^ expandedKey128[11];
        }
