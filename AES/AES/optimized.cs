...
namespace AES
{
    ...
    class AESe : SimpleProcess {
        ...
        private void Encrypt128() {
            ...
            /* Round 1 */
                        /* Sub-round 1 */
			uint b0 = T0[a0 >> 24] ^ expandedKey128[4];
                        /* Sub-round 2 */
                        b0 ^= T1[(byte)(a1 >> 16)];
			uint b1 = T0[a1 >> 24] ^ expandedKey128[5];
                        /* Sub-round 3 */
                        b0 ^= T2[(byte)(a2 >> 8)];
                        b1 ^= T1[(byte)(a2 >> 16)];
                        uint b2 = T0[a2 >> 24] ^ expandedKey128[6];
                        /* Sub-round 4 */
                        b0 ^= T3[(byte)a3];
                        b1 ^= T2[(byte)(a3 >> 8)];
                        b2 ^= T1[(byte)(a3 >> 16)];
			uint b3 = T0[a3 >> 24] ^ expandedKey128[7];
	    /* Round 2 */
                        /* Sub-round 5 */
                        b1 ^= T3[(byte)a0];
                        b2 ^= T2[(byte)(a0 >> 8)];
			b3 ^= T1[(byte)(a0 >> 16)];
                        a0 = T0[b0 >> 24] ^ expandedKey128[8];

                        /* Sub-round 6 */
                        b2 ^= T3[(byte)a1];
                        b3 ^= T2[(byte)(a1 >> 8)];
                        a0 ^= T1[(byte)(b1 >> 16)];
			a1 = T0[b1 >> 24] ^ expandedKey128[9];

                        /* Sub-round 7 */
                        b3 ^= T3[(byte)a2];
                        a0 ^= T2[(byte)(b2 >> 8)];
                        a1 ^= T1[(byte)(b2 >> 16)];
			a2 = T0[b2 >> 24] ^ expandedKey128[10];

                        /* Sub-round 8 */
                        a0 ^= T3[(byte)b3];
                        a1 ^= T2[(byte)(b3 >> 8)];
                        a2 ^= T1[(byte)(b3 >> 16)];
			a3 = T0[b3 >> 24] ^ expandedKey128[11];
	    /* Round 3 */
                        /* Sub-round 9 */
                        a1 ^= T3[(byte)b0];
                        a2 ^= T2[(byte)(b0 >> 8)];
                        a3 ^= T1[(byte)(b0 >> 16)];
                        b0 = T0[a0 >> 24] ^ expandedKey128[12];

                        /* Sub-round 10 */
                        a2 ^= T3[(byte)b1];
                        a3 ^= T2[(byte)(b1 >> 8)];
                        b0 ^= T1[(byte)(a1 >> 16)];
			b1 = T0[a1 >> 24] ^ expandedKey128[13];

                        /* Sub-round 11 */
                        a3 ^= T3[(byte)b2];
                        b0 ^= T2[(byte)(a2 >> 8)];
                        b1 ^= T1[(byte)(a2 >> 16)];
			b2 = T0[a2 >> 24] ^ expandedKey128[14];

                        /* Sub-round 12 */
                        b0 ^= T3[(byte)a3];
                        b1 ^= T2[(byte)(a3 >> 8)];
                        b2 ^= T1[(byte)(a3 >> 16)];
			b3 = T0[a3 >> 24] ^ expandedKey128[15];
	    /* Round 4 */
                        /* Sub-round 13 */
                        b1 ^= T3[(byte)a0];
                        b2 ^= T2[(byte)(a0 >> 8)];
                        b3 ^= T1[(byte)(a0 >> 16)];
			a0 = T0[b0 >> 24] ^ expandedKey128[16];

                        /* Sub-round 14 */
                        b2 ^= T3[(byte)a1];
                        b3 ^= T2[(byte)(a1 >> 8)];
                        a0 ^= T1[(byte)(b1 >> 16)];
			a1 = T0[b1 >> 24] ^ expandedKey128[17];

                        /* Sub-round 15 */
                        b3 ^= T3[(byte)a2];
                        a0 ^= T2[(byte)(b2 >> 8)];
                        a1 ^= T1[(byte)(b2 >> 16)];
			a2 = T0[b2 >> 24] ^ expandedKey128[18];

                        /* Sub-round 16 */
                        a0 ^= T3[(byte)b3];
                        a1 ^= T2[(byte)(b3 >> 8)];
                        a2 ^= T1[(byte)(b3 >> 16)];
			a3 = T0[b3 >> 24] ^ expandedKey128[19];
	    /* Round 5 */
                        /* Sub-round 17 */
                        a1 ^= T3[(byte)b0];
                        a2 ^= T2[(byte)(b0 >> 8)];
                        a3 ^= T1[(byte)(b0 >> 16)];
			b0 = T0[a0 >> 24] ^ expandedKey128[20];

                        /* Sub-round 18 */
                        a2 ^= T3[(byte)b1];
                        a3 ^= T2[(byte)(b1 >> 8)];
                        b0 ^= T1[(byte)(a1 >> 16)];
			b1 = T0[a1 >> 24] ^ expandedKey128[21];

                        /* Sub-round 19 */
                        a3 ^= T3[(byte)b2];
                        b0 ^= T2[(byte)(a2 >> 8)];
                        b1 ^= T1[(byte)(a2 >> 16)];
			b2 = T0[a2 >> 24] ^ expandedKey128[22];

                        /* Sub-round 20 */
                        b0 ^= T3[(byte)a3];
                        b1 ^= T2[(byte)(a3 >> 8)];
                        b2 ^= T1[(byte)(a3 >> 16)];
			b3 = T0[a3 >> 24] ^ expandedKey128[23];
	    /* Round 6 */
                        /* Sub-round 21 */
                        b1 ^= T3[(byte)a0];
                        b2 ^= T2[(byte)(a0 >> 8)];
                        b3 ^= T1[(byte)(a0 >> 16)];
                        a0 = T0[b0 >> 24] ^ expandedKey128[24];

                        /* Sub-round 22 */
                        b2 ^= T3[(byte)a1];
                        b3 ^= T2[(byte)(a1 >> 8)];
                        a0 ^= T1[(byte)(b1 >> 16)];
			a1 = T0[b1 >> 24] ^ expandedKey128[25];

                        /* Sub-round 23 */
                        b3 ^= T3[(byte)a2];
                        a0 ^ T2[(byte)(b2 >> 8)];
                        a1 ^= T1[(byte)(b2 >> 16)];
			a2 = T0[b2 >> 24] ^ expandedKey128[26];

                        /* Sub-round 24 */
                        a0 ^= T3[(byte)b3];
                        a1 ^= T2[(byte)(b3 >> 8)];
                        a2 ^= T1[(byte)(b3 >> 16)];
			a3 = T0[b3 >> 24] ^ expandedKey128[27];
	     /* Round 7 */
                        /* Sub-round 25 */
                        a1 ^= T3[(byte)b0];
                        a2 ^= T2[(byte)(b0 >> 8)];
                        a3 ^= T1[(byte)(b0 >> 16)];
			b0 = T0[a0 >> 24] ^ expandedKey128[28];

                        /* Sub-round 26 */
                        a2 ^= T3[(byte)b1];
                        a3 ^= T2[(byte)(b1 >> 8)];
                        b0 ^= T1[(byte)(a1 >> 16)];
			b1 = T0[a1 >> 24] ^ expandedKey128[29];

                        /* Sub-round 27 */
                        a3 ^= T3[(byte)b2];
                        b0 ^= T2[(byte)(a2 >> 8)];
                        b1 ^= T1[(byte)(a2 >> 16)];
                        b2 = T0[a2 >> 24] ^ expandedKey128[30];

                        /* Sub-round 28 */
                        b0 ^= T3[(byte)a3];
                        b1 ^= T2[(byte)(a3 >> 8)];
                        b2 ^= T1[(byte)(a3 >> 16)];
			b3 = T0[a3 >> 24] ^ expandedKey128[31];
	     /* Round 8 */
                        /* Sub-round 29 */
                        b1 ^= T3[(byte)a0];
                        b2 ^= T2[(byte)(a0 >> 8)];
                        b3 ^= T1[(byte)(a0 >> 16)];
			a0 = T0[b0 >> 24] ^ expandedKey128[32];

                        /* Sub-round 30 */
                        b2 ^= T3[(byte)a1];
                        b3 ^= T2[(byte)(a1 >> 8)];
                        a0 ^= T1[(byte)(b1 >> 16)];
			a1 = T0[b1 >> 24] ^ expandedKey128[33];

                        /* Sub-round 31 */
                        b3 ^= T3[(byte)a2];
                        a0 ^= T2[(byte)(b2 >> 8)];
                        a1 ^= T1[(byte)(b2 >> 16)];
			a2 = T0[b2 >> 24] ^ expandedKey128[34];

                        /* Sub-round 32 */
                        a0 ^= T3[(byte)b3];
                        a1 ^= T2[(byte)(b3 >> 8)];
                        a2 ^= T1[(byte)(b3 >> 16)];
			a3 = T0[b3 >> 24] ^ expandedKey128[35];
	     /* Round 9 */
                        /* Sub-round 33 */
                        a1 ^= T3[(byte)b0];
                        a2 ^= T2[(byte)(b0 >> 8)];
                        a3 ^= T1[(byte)(b0 >> 16)];
			b0 = T0[a0 >> 24] ^ expandedKey128[36];

                        /* Sub-round 34 */
                        a2 ^= T3[(byte)b1];
                        a3 ^= T2[(byte)(b1 >> 8)];
                        b0 ^= T1[(byte)(a1 >> 16)];
			b1 = T0[a1 >> 24] ^ expandedKey128[37];

                        /* Sub-round 35 */
                        a3 ^= T3[(byte)b2];
                        b0 ^= T2[(byte)(a2 >> 8)];
                        b1 ^= T1[(byte)(a2 >> 16)];
			b2 = T0[a2 >> 24] ^ expandedKey128[38];

                        /* Sub-round 36 */
                        b0 ^= T3[(byte)a3];
                        b1 ^= T2[(byte)(a3 >> 8)];
                        b2 ^= T1[(byte)(a3 >> 16)];
			b3 = T0[a3 >> 24] ^ expandedKey128[39];
